...
<div class="row">
    <div class="col-lg-12">
        <section class="card">            
            <header class="card-header">Fill this Form & Edit Your Blogs</header>
            <div class="card-body">
                <form method="post" 
                enctype="multipart/form-data" 
                action="{{URL::to('admin/blogs/update/')}}/{{Crypt::encryptString($module->id)}}" >
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Title</label>
                                <input type="text"  value="{{$module->title}}" class="title form-control" placeholder="Title" name="title" >
                                @if($errors->has('title'))
                                ...
                                <div class="col-lg-12">
                                    <div class="">
                                        <input type="file" name="banner" class="d-block pb-3" />
                                           <a target="_blank" class="" href="{{asset('/admin/uploads/'.$module->banner)}}">
                                            <img style="width: 100px;height:100px" style="width:50px;height:50px" src="{{asset('/admin/uploads/'.$module->banner)}}" />
                                           </a>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"  value="{{$module->banner_alt}}" class="form-control" placeholder="Banner Alt" name="banner_alt" >
                         ...
                         <div class="col-md-12">
                            <section class="card">
                                ...
                                <div class="card-body">
                                    <textarea class="form-control" name="short_des">{{$module->short_des}}</textarea>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Sorting</label>
                                <input type="number" value="{{$module->sort}}" name="sort" 
                                class="form-control"
                                placeholder="Sorting">
                                @if($errors->has('sort'))
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="tagsinput" class="tagsinput" value="{{$module->meta_keywords}}" type="text" name="meta_keywords"   
                                placeholder="Meta Description">
