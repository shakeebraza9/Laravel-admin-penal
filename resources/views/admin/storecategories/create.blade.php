...
<div class="row">
    <div class="col-lg-12">
        <section class="card">
            <header class="card-headers">ADD YOUR STORES CATEGORIES</header>
        </section>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <section class="card">            
            <header class="card-header">
                Fill this Form & Create Your Stores Categories
            </header>
            <div class="card-body">
                <form method="post" enctype="multipart/form-data" action="{{URL::to('admin/storecategories/store')}}" >
                    @csrf
                    <div class="row">
